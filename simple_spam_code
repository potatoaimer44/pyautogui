...
messages=(
  ...
  "If the speed of light is 299,792 km/s, what is the speed of dark?",
  "Do you think the ocean is salty because the seaweed?",
  "Why do they sterilize needles for lethal injections?",
  "If you cross a wolf with a tortoise, what do you get? I have no idea, but if it’s chasing me, I’m climbing a tree!",
  "Do you think aliens believe in humans?",
  "Why do 'fat chance' and 'slim chance' mean the same thing?",
  "If you send a letter to Santa and it gets lost in the mail, does he still get it?",
)
time.sleep(5)
